...
puts "Hello There!, Welcome to Matches App"
puts "Basically this is just a simple quick script to setup Matches environment"
...
puts "3. API_KEY_Debug for Matches"
ENV["MatchesAPIKeyDebug"] = gets.chomp
puts "4. API_KEY_Release for Matches"
ENV["MatchesAPIKeyRelease"] = gets.chomp
